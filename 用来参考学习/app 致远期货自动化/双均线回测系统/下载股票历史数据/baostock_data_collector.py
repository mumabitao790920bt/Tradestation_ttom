...
class BaoStockDataCollector:
    def __init__(self):
        ...
        self.frequency_mapping = {
            ...
            'quarterly': {'level': 10, 'frequency': 'q', 'table': 'quarterly_data'},
            'yearly': {'level': 11, 'frequency': 'y', 'table': 'yearly_data'}
        }
    ...
    def get_stock_history_data(self, code, frequency_info, start_date='1990-01-01'):
        ...
        # 构建查询字段
        if frequency_info['frequency'] in ['d', 'w', 'm']:
